...
# Judul aplikasi
st.markdown("<h1 class='header'>AI-Powered Fact-Checking Tool for WhatsApp Forwarded Messages</h1>", unsafe_allow_html=True)

# Deskripsi singkat proyek
st.markdown("""
<div class='project-description'>
This AI tool checks the accuracy of WhatsApp forwarded messages and helps you identify false information easily.
</div>
""", unsafe_allow_html=True)
