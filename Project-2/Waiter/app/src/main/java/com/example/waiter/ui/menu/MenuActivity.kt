...
import com.example.waiter.adapter.MenuAdapter
...
class MenuActivity : AppCompatActivity(), MenuView, TambahTempView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.swlayout.setOnRefreshListener {
            ...
            menuPresenter.getResponse(idKategori, "")
        }

        menuPresenter = MenuPresenter(this)
        tambahTempPresenter = TambahTempPresenter(this)

        idKategori = intent.getStringExtra("id_kategori").toString()
        menuPresenter.getResponse(idKategori, "")
                ...
                object : TextWatcher {
                    ...
                    override fun onTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
                        ...
                        if (charSequence.length > 2) {
                            ...
                            menuPresenter.getResponse(idKategori, nmMenu)
                        }
                    }
...
//        bindings!!.recycler.visibility = View.VISIBLE
        ...
        menuAdapter = MenuAdapter(this, this, payloadMenu as ArrayList<PayloadMenu>)
